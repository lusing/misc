...
# 打印剪枝前的参数数量
num_params_before = sum(p.numel() for name, p in net.fc1.named_parameters() if 'weight' in name)
...
# 打印剪枝后的参数数量
num_params_after = sum(p.numel() for name, p in net.fc1.named_parameters() if 'weight' in name)
